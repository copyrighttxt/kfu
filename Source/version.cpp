...
{
	if (HINTERNET internet = InternetOpenA("copyrighttxt/kfu", INTERNET_OPEN_TYPE_PRECONFIG, NULL, NULL, NULL))
	{
...
bool CheckForUpdates()
{
	...
	{
		char buffer[256];
		sprintf_s(buffer, "A new version of Kireon FPS Unlocker is available.\n\nCurrent Version: %s\nLatest Version: %s\n\nVisit download page?", KFU_VERSION, latest_version.c_str());
